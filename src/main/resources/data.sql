...
(2, 'Hello, everyone! How are you all doing today?', ROUND(RANDOM() * 100)),
(3, 'Testing, testing, 1, 2, 3...', ROUND(RANDOM() * 100)),
(4, 'Hey there! Whats up?', ROUND(RANDOM() * 100)),
(1, 'Im new here, nice to meet you all!', ROUND(RANDOM() * 100)),
(2, 'Anyone up for a chat?', ROUND(RANDOM() * 100)),
(3, 'Just sharing a random thought.', ROUND(RANDOM() * 100)),
(4, 'Checking in! Hows everyone day going?', ROUND(RANDOM() * 100)),
(1, 'First time posting here. Excited to be part of the community!', ROUND(RANDOM() * 100)),
(2, 'Whats the latest gossip?', ROUND(RANDOM() * 100)),
(3, 'Thinking about what to have for dinner...', ROUND(RANDOM() * 100)),
(4, 'Feeling productive today!', ROUND(RANDOM() * 100)),
(1, 'Just wanted to say hi to everyone!', ROUND(RANDOM() * 100)),
(2, 'Looking forward to some interesting conversations!', ROUND(RANDOM() * 100)),
(3, 'Its a beautiful day outside. Enjoying the sunshine!', ROUND(RANDOM() * 100));
