...
('john_doe', 'john@example.com', '$2a$10$n7v9.qKPWgvpfSFESerP7ecXEDIIx35ORQNtHYsGqertQKIHILaMa', 'JohnD', 'Hello, I am John!', 'USER', '/uploads/profile-pictures/default_profile_picture.png'),
('jane_smith', 'jane@example.com', '$2a$10$3AbvE7cIYazTZjaX2q.YnumqO0ZhxflQDMcptWQMvssQ89xLt2u6C', 'JaneS', 'Nice to meet you all!', 'USER', '/uploads/profile-pictures/default_profile_picture.png'),
('sam_wilson', 'sam@example.com', '$2a$10$Cetv53n9L0FSuTRfa2ZTEef7bXxYmOnuwiSXCWBH9307UTdmGr39y', 'SamW', 'Just a regular guy.', 'USER', '/uploads/profile-pictures/default_profile_picture.png'),
('Daniel', 'daniel1@gmail.com', '$2a$10$Pwr9PEvjq5LRHweHOcasoOSI84switTEXMRmRr1/165QBevF.5OXK', 'Daniel1', 'Main account.', 'ADMIN', '/uploads/profile-pictures/dog.png');
